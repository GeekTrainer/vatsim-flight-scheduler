...
const ARTCC_CENTERS: Record<string, { lat: number; lon: number; radius: number; name: string }> = {
	ZAB: { lat: 33.5, lon: -109.0, radius: 350, name: 'Albuquerque Center' },
	ZAU: { lat: 41.8, lon: -88.5, radius: 250, name: 'Chicago Center' },
	ZBW: { lat: 42.5, lon: -71.5, radius: 250, name: 'Boston Center' },
	ZDC: { lat: 39.0, lon: -77.5, radius: 250, name: 'Washington Center' },
	ZDV: { lat: 39.5, lon: -105.0, radius: 300, name: 'Denver Center' },
	ZFW: { lat: 32.8, lon: -97.0, radius: 300, name: 'Fort Worth Center' },
	ZHU: { lat: 29.5, lon: -95.5, radius: 300, name: 'Houston Center' },
	ZID: { lat: 39.5, lon: -84.5, radius: 250, name: 'Indianapolis Center' },
	ZJX: { lat: 30.5, lon: -81.5, radius: 300, name: 'Jacksonville Center' },
	ZKC: { lat: 38.5, lon: -94.5, radius: 300, name: 'Kansas City Center' },
	ZLA: { lat: 34.0, lon: -118.0, radius: 300, name: 'Los Angeles Center' },
	ZLC: { lat: 41.0, lon: -112.0, radius: 350, name: 'Salt Lake City Center' },
	ZMA: { lat: 26.0, lon: -80.5, radius: 300, name: 'Miami Center' },
	ZME: { lat: 35.5, lon: -90.0, radius: 300, name: 'Memphis Center' },
	ZMP: { lat: 45.0, lon: -93.5, radius: 350, name: 'Minneapolis Center' },
	ZNY: { lat: 40.7, lon: -74.0, radius: 200, name: 'New York Center' },
	ZOA: { lat: 37.5, lon: -122.0, radius: 300, name: 'Oakland Center' },
	ZOB: { lat: 41.0, lon: -82.0, radius: 250, name: 'Cleveland Center' },
	ZSE: { lat: 47.5, lon: -122.5, radius: 350, name: 'Seattle Center' },
	ZTL: { lat: 33.8, lon: -84.5, radius: 250, name: 'Atlanta Center' },
};
