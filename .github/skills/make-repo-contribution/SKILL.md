...
If an issue was created or is being used, ensure that issue is referenced in the PR. If you have any questions or confusion, ask the user for input on how best to proceed.
